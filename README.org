...
- Rebug :: Eyeballed, but thoroughly.
...
- Rebug :: I wanted a theme that used three simple colors in generated grades.  This would make generating alternate color-schemes easier.  This allows modifying the base palette to generate a completely different theme.
...
Themes generated from a four color: R, G, B and K.  Colors are generated from a list of Alpha values.

Six themes:
- Rebug
- Rebug Flipped
- Rebug Alternate 
- Rebug Alternate Flipped
- Rebug Lawn Lush
- Rebug Lawn Sere
